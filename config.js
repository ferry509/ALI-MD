...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "STARK-ALI~HsIRHJ4C#UuWEMtjCR7UAHBQEAnwXq2DreLMAZw1rN7OfDjRtSos",
// add your Session Id 
...
BOT_NAME: process.env.BOT_NAME || "➻𒍜➻.₣ËŖŖŸ PŖÖMÖ ĐȚȞ𒈞꧂",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "➻𒍜➻₣ËŖŖŸ PŖÖMÖ ĐȚȞ𒈞꧂",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "50939940477",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "ferry",
// add bot owner name 
